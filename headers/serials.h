...
inline std::string GetBiosSerialNumber() {
...
inline std::string GetChassisSerialNumber() {
    std::string serialNumber;
...
inline std::string GetBaseboardModel() {
    std::string model;
...
inline bool IsBluetoothEnabled() {
...
inline std::string GetNetworkAdapter() {
...
inline std::string GetBaseboardManufacturer() {
...
inline std::string GetCpuSerialNumber() {
    std::string serialNumber;
...
inline std::string GetMoboSerialNumber() {
    std::string serialNumber;
    std::string command = "wmic baseboard get serialnumber";
    FILE* pipe = _popen(command.c_str(), "r");
    if (!pipe) {
